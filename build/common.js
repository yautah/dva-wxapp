...
var _isPlainObject2 = __webpack_require__(155);
...
var _buffers = __webpack_require__(62);

var _scheduler = __webpack_require__(81);
...
var _sagaHelpers = __webpack_require__(82);
...
var symbol_observable = __webpack_require__(144);
...
exports.request = exports.connect = exports.mergeOptions = undefined;
...
var _takeEvery = __webpack_require__(151);

var _takeEvery2 = _interopRequireDefault(_takeEvery);

var _takeLatest = __webpack_require__(152);

var _takeLatest2 = _interopRequireDefault(_takeLatest);

var _throttle = __webpack_require__(153);
...
var createConnect = function createConnect(mapStateToProps, mapDispatchToProps) {
  var app = getApp();
  ...
  var mapDispatch = mapDispatchToProps || defaultMapDispatchToProps;
  ...
  return function (page) {
    ...
    function onLoad(options) {
      var isMapStateToProps = Boolean(mapStateToProps);
    ...
    var abc = mapDispatch(app._store.dispatch);

    return (0, _assign2.default)({}, page, mapDispatch(app._store.dispatch), { dispatch: app._store.dispatch }, { onLoad: onLoad, onUnload: onUnload });
  };
};
...
var _weakMap = __webpack_require__(92);
...
if ((typeof global === 'undefined' ? 'undefined' : (0, _typeof3.default)(global)) === 'object') {
	global.Array = Array;
	...
	global.WeakMap = _weakMap2.default;
...
var _checkModel = __webpack_require__(154);

var _checkModel2 = _interopRequireDefault(_checkModel);

var _prefixNamespace = __webpack_require__(157);
...
var _runSaga = __webpack_require__(149);
...
var _proc = __webpack_require__(150);
...
var _io = __webpack_require__(40);
...
var _fsmIterator = __webpack_require__(63);
...
exports.default = function (_ref) {
  ...
  if ("development" !== 'production' && _window2.default.__REDUX_DEVTOOLS_EXTENSION__) {
...
var _flatten = __webpack_require__(165);
...
var _window = __webpack_require__(166);
...
var _effects = __webpack_require__(170);
...
var _prefixType = __webpack_require__(84);
...
var channel__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
io_put.sync = deprecate(io_put.resolve, updateIncentive('put.sync', 'put.resolve'));
...
var asEffect = {
  ...
  fork: createAsEffectType(FORK),
  join: createAsEffectType(JOIN),
  cancel: createAsEffectType(io_CANCEL),
  select: createAsEffectType(SELECT),
  actionChannel: createAsEffectType(ACTION_CHANNEL),
  cancelled: createAsEffectType(CANCELLED),
  flush: createAsEffectType(FLUSH),
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "take", function() { return io_take; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "takem", function() { return takem; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "put", function() { return io_put; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "all", function() { return io_all; });
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "apply", function() { return apply; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "cps", function() { return cps; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "fork", function() { return fork; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "spawn", function() { return spawn; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "join", function() { return join; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "cancel", function() { return cancel; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "select", function() { return io_select; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "actionChannel", function() { return actionChannel; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "cancelled", function() { return cancelled; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "flush", function() { return io_flush; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "getContext", function() { return getContext; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "setContext", function() { return setContext; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "takeEvery", function() { return io_takeEvery; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "takeLatest", function() { return io_takeLatest; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "throttle", function() { return io_throttle; });
...
var _prefixedDispatch = __webpack_require__(179);
...
var _diff = __webpack_require__(182);
...
exports.default = [_app2.default, _index2.default];
...
exports.default = {
  ...
  reducers: {
    getSysInfoSuccess: function getSysInfoSuccess(state, action) {
      var sysInfo = action.payload;
      return (0, _extends3.default)({}, state, { sysInfo: sysInfo });
    },
    getLocationSuccess: function getLocationSuccess(state, action) {
  ...
  effects: {
    getSysInfo: _regenerator2.default.mark(function getSysInfo(action, _ref) {
      var call = _ref.call,
          put = _ref.put;
      var sysInfo;
      return _regenerator2.default.wrap(function getSysInfo$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return call(_wx2.default.getSystemInfo);

            case 2:
              sysInfo = _context.sent;
              _context.next = 5;
              return put({ type: 'getSysInfoSuccess', payload: sysInfo });
    ...
    getLocation: _regenerator2.default.mark(function getLocation(action, _ref2) {
      var call = _ref2.call,
          put = _ref2.put;
      var location;
      return _regenerator2.default.wrap(function getLocation$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return call(_wx2.default.getLocation);

            case 3:
              location = _context2.sent;
              _context2.next = 6;
              return put({ type: 'getLocationSuccess', payload: location });
...
var makeOptions = function makeOptions(url, options) {
  var defaultoptions = {
    url: undefined,
    method: 'GET',
    qs: undefined,
  ...
  thisoptions = (0, _assign2.default)({}, defaultoptions, thisoptions);

  return thisoptions;
};

var addQs = function addQs(url, qs) {
  var queryString = '';
  var newUrl = url;
  if (qs && (typeof qs === 'undefined' ? 'undefined' : (0, _typeof3.default)(qs)) === 'object') {
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)((0, _keys2.default)(qs)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var k = _step.value;
...
var request = function request(url, options) {
  var opts = makeOptions(url, options);
  ...
  if ((!headers || !headers['content-type']) && contentType) {
    header = (0, _assign2.default)({}, headers, { 'content-type': contentType });
  }
    ...
    wx.request({
      ...
      success: function success(response) {
        ...
        if (response.statusCode < 200 || response.statusCode >= 300) {
          ...
          if (response.data && (0, _typeof3.default)(response.data) === 'object') {
            errors = (0, _assign2.default)({}, errors, response.data);
          }
          reject(errors);
        }
      ...
      fail: function fail(err) {
        ...
        reject({ error: -1, message: '系统异常，请查看response', err: err, request: url });
      }
    });
  });
};
...
exports.default = {
  ...
  onTapCarouselItem: function onTapCarouselItem() {
